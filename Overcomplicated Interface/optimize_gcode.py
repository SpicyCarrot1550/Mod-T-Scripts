# This is modified version of u/ngorgi's optimize script (the one in the original software) which has been made into a function to interface with the tui
...
def optimize_gcode(infname, outfname):
    global newSequence
    global sequenceXYZ
    global sequenceE
    global sequenceFeedrate
