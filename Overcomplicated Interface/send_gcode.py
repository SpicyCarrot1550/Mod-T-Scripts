...
def send_gcode(fname):
    ...
    dev.set_configuration() # Probally unecessary
    #
    # These came from usb dump. They are likely unecessary, but are left in better replicate the original program
